...
def display_header():
    ...
    with st.container():
        ...
        with col1:
            ...
            st.caption("Your hyper-intelligent, multi-modal AI companion | Developed by Harsh Kumar")
...
def setup_sidebar():
    ...
    with st.sidebar:
        ...
        st.markdown("---")
        st.markdown("**Created by:** Harsh Kumar")
...
def generate_response(user_input, groq_chat):
...
def main_chat_interface(groq_chat):
    ...
    if submitted and user_input:
        ...
        response = generate_response(user_input, groq_chat)
